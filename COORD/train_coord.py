...
def train_autocoder(type="BM", save_code=False, display=False, step=10):
    trainset_dir = r"E:\Data\DATASET\SealDigitTwin\Results\0_input_npy\COORD_ALL\\"
...
if __name__ == '__main__':
    # train_autocoder(type="BM", display=False, step=10)
    # train_autocoder(type="PR", display=True, step=10)
    # train_autocoder(type="NB", display=True, step=10)
    #
